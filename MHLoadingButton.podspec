#
#  Be sure to run `pod spec lint MHLoadingButton.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/twho/loading-buttons-ios"
  ...
  # Or just: spec.author    = "Michael Ho"
  # spec.authors            = { "Michael Ho" => "tsungwei50521@gmail.com" }
  spec.social_media_url   = "https://medium.com/@twho"
  ...
  spec.source       = { :git => "https://github.com/twho/loading-buttons-ios.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "LoadingButtons", "LoadingButtons/**/*.{h,m,swift}"
  spec.exclude_files = "LoadingButtonsDemo/**", "LoadingButtonsDemoUITests/**"
